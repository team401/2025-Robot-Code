...
public interface WristIO {
  ...
  public static class WristInputs {
    ...
    /**
     * Current position of the wristEncoder. This measures total rotation since power on, not
     * absolute position
     */
  ...
  /**
   * Updates a WristInputs with the current information from sensors readings and from the motors.
   *
  ...
  /**
   * Set the position of the wristEncoder. This position is separate from absolute position and can
