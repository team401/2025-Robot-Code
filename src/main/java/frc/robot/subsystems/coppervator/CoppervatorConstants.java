...
public final class CoppervatorConstants {
  ...
  public static ElevatorMechanismConfig mechanismConfig =
    ...
    return new TalonFXConfiguration()
        ...
        .withMotionMagic(
            new MotionMagicConfigs()
                ...
                .withMotionMagicExpo_kV(ElevatorConstants.synced.getObject().elevatorExpo_kV_raw));
  }
    ...
    return new CANcoderConfiguration()
        .withMagnetSensor(
            new MagnetSensorConfigs()
                .withSensorDirection(
                    JsonConstants.elevatorConstants.elevatorLargeCANCoderDirection));
  }
}
