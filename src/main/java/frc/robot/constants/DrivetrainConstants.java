...
public class DrivetrainConstants {
  ...
  public final ClosedLoopOutputType kDriveClosedLoopOutput = ClosedLoopOutputType.Voltage;
  ...
  public final Current kSlipCurrent = Amps.of(120.0);
  ...
  public final double kCoupleRatio = 0;

  public final double kDriveGearRatio = 6.75;
  public final double kSteerGearRatio = 25;
  public final Distance kWheelRadius = Inches.of(2);

  public final boolean kInvertLeftSide = false;
  public final boolean kInvertRightSide = true;

  public final int kPigeonId = 13;

  // These are only used for simulation
  public final MomentOfInertia kSteerInertia = KilogramSquareMeters.of(0.01);
  public final MomentOfInertia kDriveInertia = KilogramSquareMeters.of(0.01);
  // Simulated voltage necessary to overcome friction
  public final Voltage kSteerFrictionVoltage = Volts.of(0.2);
  public final Voltage kDriveFrictionVoltage = Volts.of(0.2);
  ...
  public final Distance kFrontLeftXPos = Inches.of(13);
  public final Distance kFrontLeftYPos = Inches.of(11.5);
  ...
  public final Distance kFrontRightXPos = Inches.of(13);
  public final Distance kFrontRightYPos = Inches.of(-11.5);
  ...
  public final Distance kBackLeftXPos = Inches.of(-13);
  public final Distance kBackLeftYPos = Inches.of(11.5);
